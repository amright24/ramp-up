...
//  ramp-up
//
//  Created by Austin Rightnowar on 4/5/19.
...
class RampPickerVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        node?.position = SCNVector3Make(0.0, 1.15, -1.5)
